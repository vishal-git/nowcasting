...
if __name__ == '__main__':
    # Configuration
    EXPERIMENT_NAME = 'xgboost_fwd_bwd_fine_tune'
 ...
 'sku_with_discount_%'
    ...
    models = {
        ...
        'GradientBoosting': GradientBoostingRegressor(random_state=42, min_samples_split=0.04, n_estimators= 300, max_depth= 7, learning_rate=0.2),
        'XGBoost': xg.XGBRegressor(random_state=42, seed=123, colsample_bytree= 0.8, gamma= 0, learning_rate= 0.1, max_depth= 3, min_child_weight= 1, n_estimators= 300, reg_alpha= 0.01, reg_lambda= 2, subsample= 1.0)
    }
